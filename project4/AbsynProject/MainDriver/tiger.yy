...
funcdec	:	FUNCTION ID LPAREN typefields RPAREN COLON ID EQ exp
			{	
				$$ = new absyn::FunctionDec(@1.first_line, @1.first_column, *$2, $4, new absyn::NameTy(@7.first_line, @7.first_column, *$7), $9, NULL); 
			}
		|	FUNCTION ID LPAREN RPAREN COLON ID EQ exp
			{	
				$$ = new absyn::FunctionDec(@1.first_line, @1.first_column, *$2, NULL, new absyn::NameTy(@7.first_line, @7.first_column, *$6), $8, NULL); 
			}
		...
		|	FUNCTION ID LPAREN RPAREN EQ exp
			{	
				$$ = new absyn::FunctionDec(@1.first_line, @1.first_column, *$2, NULL, NULL, $6, NULL); 
			}
		;
...
typefields	:	
			|	ID COLON ID COMMA typefields
				{	
					$$ = new absyn::FieldList(@1.first_line, @1.first_column, *$1, *$3, $5); 
				}
			|	ID COLON ID
				{	
